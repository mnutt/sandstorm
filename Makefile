...
tmp/.shell-env: tmp/.ekam-run $(IMAGES) shell/imports/client/changelog.html shell/imports/client/styles/global/_icons.scss shell/imports/client/styles/icons/_api.scss shell/package.json shell/package-lock.json
...
shell/imports/client/styles/global/_icons.scss shell/imports/client/styles/icons/_api.scss: icons/node_modules icons/*svg icons/build.js icons/codepoints.json
