...
This is a data-plane example. If a public capability needs both typed control
methods and large byte streams, use native `capnp:` RPC for selecting or
authorizing the object and return a `WebSession`/fetch-shaped capability for
the stream.
