...
export declare class NativeCapnpBridgeRequest extends $.Struct {
  static readonly OBSOLETE_CALL: 0;
  ...
  get _isObsoleteCall(): boolean;
  set obsoleteCall(_: true);
...
export declare class NativeCapnpBridgeResponse extends $.Struct {
  static readonly OBSOLETE_RESULT: 0;
  ...
  get protocolVersion(): number;
  set protocolVersion(value: number);
  get _isObsoleteResult(): boolean;
  set obsoleteResult(_: true);
