...
module.exports["Test Ip Networking"] = function (browser) {
  browser
    ...
    .frameParent()
    .waitForElementVisible(".topbar-popup.request .candidate-cards .powerbox-card button[data-card-id=frontendref-ipnetwork]", short_wait)
    .captureVisualSnapshot(".topbar-popup.request", "powerbox-ip-network-request")
    .click(".topbar-popup.request .candidate-cards .powerbox-card button[data-card-id=frontendref-ipnetwork]")
    .grainFrame()
...
module.exports["Test Ip Interface"] = function (browser) {
  browser
    ...
    .frameParent()
    .waitForElementVisible(".topbar-popup.request .candidate-cards .powerbox-card button[data-card-id=frontendref-ipinterface]", short_wait)
    .captureVisualSnapshot(".topbar-popup.request", "powerbox-ip-interface-request")
    .click(".topbar-popup.request .candidate-cards .powerbox-card button[data-card-id=frontendref-ipinterface]")
    .grainFrame()
      .waitForElementVisible("span.token", short_wait)
