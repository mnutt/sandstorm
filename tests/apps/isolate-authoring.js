      ...
      browser
        ...
        .windowHandles(function (logWindows) {
          browser
            ...
            .click(".authoring-actions button[type=submit]")
            .waitForElementVisible(".operation-status.success", long_wait)
            .windowHandles(function (revisionWindows) {
              browser
                .switchWindow(revisionWindows.value[1])
                .waitForElementVisible("#grainTitle", long_wait)
                .grainFrame()
                .waitForElementVisible("body", medium_wait)
                ...
                .frameParent()
                .closeWindow()
                .switchWindow(revisionWindows.value[0])
                .click(".reset-preview")
